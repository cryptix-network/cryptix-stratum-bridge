...
import (
	...
	"github.com/cryptix-network/cryptix-stratum-bridge/src/cryptixstratum"
	"gopkg.in/yaml.v2"
)
...
func main() {
	...
	flag.StringVar(&cfg.RPCServer, "cryptix", cfg.RPCServer, "address of the cryptixd node")
	...
	log.Printf("\tcryptixd:        %s", cfg.RPCServer)
